...
public class EmailUtils {
	...
	public static void sendRecoveryConfirm(String encEmail,String email) throws IOException {
		if (!active) {
			return;
		}
		Mail mail = new Mail();
	    ...
	    Personalization personalization = new Personalization();
	    personalization.addDynamicTemplateData("encEmail" , encEmail);
...
public static void sendNewPassword(UserDTO UserDto, String newPass) throws IOException {
	if (!active) {
		return;
	}
	Mail mail = new Mail();
    ...
    Personalization personalization = new Personalization();
    personalization.addDynamicTemplateData("userDTO" , UserDto);
    personalization.addDynamicTemplateData("newPass" , newPass);
    personalization.addTo(new Email(UserDto.getEmail()));
    mail.addPersonalization(personalization);
